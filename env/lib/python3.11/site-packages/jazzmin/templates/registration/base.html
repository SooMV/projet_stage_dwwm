...
<body class="hold-transition jazzmin-login-page bg-yellow-400">
        ...
        <h1>
            <picture>
                <source
                 ...
                 <img style="width:200px " class="mx-auto my-5" src="{% static jazzmin_settings.login_logo %}" alt="{{ jazzmin_settings.site_header }}">
            </picture>
        </h1>
    </div>
